                ...
                <p className="text-sm text-[var(--text-muted)]">
                  ...
                  {action.fix_action && (
                    <span className="ml-2 inline-flex items-center gap-1">
                      <span className="text-[10px] font-semibold uppercase tracking-wide text-[var(--text-muted)] bg-[var(--bg-secondary)] border border-[var(--border-subtle)] rounded px-1.5 py-0.5">
                        💬 Trader advisory
                      </span>
                      <span className="italic">{action.fix_action}</span>
                    </span>
                  )}
                </p>
              </div>
